...
state_born = input("Enter the state you were born: ")
state_live = input("Enter the state you live now: ")

print("You were born in", state_born)
print("You now live in", state_live)